###############################################################################
## This file is imported into jeop_app.py file to make it usable in Flask when
## running either in the csel.io virtual machine or running on a local machine.
## The code provides a prefix for any url's that are accessing files in the 
## code tree. 
###############################################################################
...
#  if running this file as main Flask application, create the Flask app to use  
if __name__ == '__main__':
    app = Flask(__name__)

###############################################################################
## Set the prefix information to access url's that access JupyterHub environment.
## 
